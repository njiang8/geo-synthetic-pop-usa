...
All the resulting datasets (85 GB uncompressed) have been made publicly available through BOX (\url{[add link](https://bit.ly/us-geo-synthetic-population)}), where interested readers can download the geographically explicit synthetic population along with their social networks by state.
